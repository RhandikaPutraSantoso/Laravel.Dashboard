...
<head>
  <meta charset="utf-8" />
  <title>Ubah Difficult - SAP HANA</title>
...
<div class="padding">
    <div class="container">
        <h2>Ubah Difficult</h2>
        <div class="alert alert-warning">
            <strong>Perhatian:</strong> Pastikan difficult valid dan efektif.
        </div>
        ...
        <div class="box">
            ...
            <div class="box-body">
                <form action="{{ route('admin.pengaturan.actiondifficult.update', $difficult['ID_DIFFICULT']) }}" method="POST">
                    ...
                    <a href="{{ route('admin.pengaturan.difficult') }}" class="btn btn-secondary">Kembali</a>
                </form>
            </div>
        </div>
    </div>
