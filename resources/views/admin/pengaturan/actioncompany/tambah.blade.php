...
<div class="container">
    <h3>Tambah COMPANY Baru</h3>
    <hr>

    <form action="{{ route('admin.pengaturan.company.store') }}" method="POST">
        @csrf

        <div class="form-group mb-3">
            <label for="NM_COMPANY">Nama COMPANY:</label>
            <input type="text" name="NM_COMPANY" id="NM_COMPANY" class="form-control" required>
        </div>
